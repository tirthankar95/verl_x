...
def get_model(repo_id, local_dir):
    ...
    for filename in filenames:
        print(hf_hub_download(repo_id=repo_id, local_dir=local_dir, token=my_token, filename=f"{filename}"))
...
if __name__ == "__main__":
    ...
    """
    get_model(repo_id=config["repo_id"], local_dir=config["local_dir"])
