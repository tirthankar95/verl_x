...
# My Grid Puzzle
file_id = "1GmXQdCeaSduODK0CRXG1XkcEsmMJA33f"
...
df_new["extra_info"] = [
    {"index": idx, "strategy": args.style} for idx in range(df.shape[0])
]
...
# Verifying content.
df_test.to_csv(HOME / "data/grid_test_easy.csv", index=False)
